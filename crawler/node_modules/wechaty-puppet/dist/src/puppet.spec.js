...
class PuppetTest extends puppet_1.Puppet {
    ...
    messageForward(to, messageId) {
        return __awaiter(this, void 0, void 0, function* () { return { messageId, to }; });
    }
    messageSendContact(receiver, contactId) {
        return __awaiter(this, void 0, void 0, function* () { return { contactId, receiver }; });
    }
    messageSendFile(to, file) {
        return __awaiter(this, void 0, void 0, function* () { return { file, to }; });
    }
    messageSendText(to, text) {
        return __awaiter(this, void 0, void 0, function* () { return { text, to }; });
    }
    messageSendUrl(to, urlLinkPayload) {
        return __awaiter(this, void 0, void 0, function* () { return { to, urlLinkPayload }; });
    }
    messageSendMiniProgram(to, miniProgramPayload) {
        return __awaiter(this, void 0, void 0, function* () { return { miniProgramPayload, to }; });
    }
...
blue_tape_1.default('contactQueryFilterFunction()', (t) => __awaiter(this, void 0, void 0, function* () {
    ...
    t.test('filter contact existing id', (t) => __awaiter(this, void 0, void 0, function* () {
        const QUERY = { id: 'id1' };
        const ID_LIST = ['id1'];
        const func = puppet.contactQueryFilterFactory(QUERY);
        const idList = PAYLOAD_LIST.filter(func).map(payload => payload.id);
    ...
    t.test('filter contact non-existing id', (t) => __awaiter(this, void 0, void 0, function* () {
...
blue_tape_1.default('roomQueryFilterFunction()', (t) => __awaiter(this, void 0, void 0, function* () {
    ...
    t.test('filter name by existing id', (t) => __awaiter(this, void 0, void 0, function* () {
        const QUERY = { id: 'id4' };
        const ID_LIST = ['id4'];
        const func = puppet.roomQueryFilterFactory(QUERY);
        const idList = PAYLOAD_LIST.filter(func).map(payload => payload.id);
    ...
    t.test('filter name by non-existing id', (t) => __awaiter(this, void 0, void 0, function* () {
...
blue_tape_1.default('contactRoomList()', (t) => __awaiter(this, void 0, void 0, function* () {
    ...
    sandbox.stub(puppet, 'roomPayload').callsFake((roomId) => __awaiter(this, void 0, void 0, function* () {
...
blue_tape_1.default('setMemory() memory with a name', (t) => __awaiter(this, void 0, void 0, function* () {
    const puppet = new PuppetTest();
    const memory = new memory_card_1.MemoryCard({ name: 'name' });
...
blue_tape_1.default('messageQueryFilterFactory() one condition', (t) => __awaiter(this, void 0, void 0, function* () {
...
blue_tape_1.default('messageQueryFilterFactory() two condition', (t) => __awaiter(this, void 0, void 0, function* () {
