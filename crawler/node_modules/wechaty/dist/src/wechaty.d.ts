...
import { Contact, ContactSelf, Friendship, Message, Room, RoomInvitation, UrlLink } from './user/';
...
export declare class Wechaty extends Accessory implements Sayable {
    ...
    emit(event: 'room-leave', room: Room, leaverList: Contact[], remover?: Contact): boolean;
    emit(event: 'room-topic', room: Room, newTopic: string, oldTopic: string, changer: Contact): boolean;
    ...
    on(event: 'room-leave', listener: string | ((this: Wechaty, room: Room, leaverList: Contact[], remover?: Contact) => void)): this;
    on(event: 'room-topic', listener: string | ((this: Wechaty, room: Room, newTopic: string, oldTopic: string, changer: Contact) => void)): this;
    on(event: 'scan', listener: string | ((this: Wechaty, qrcode: string, status: number, data?: string) => void)): this;
