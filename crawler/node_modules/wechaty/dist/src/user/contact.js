...
class Contact extends accessory_1.Accessory {
    ...
    static find(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (n = 0; n < contactList.length; n++) {
                ...
                if (valid) {
                    config_1.log.verbose('Contact', 'find() confirm contact[#%d] with id=%d is vlaid result, return it.', n, contact.id);
                    return contact;
                }
                else {
    ...
    say(textOrContactOrFileOrUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            config_1.log.verbose('Contact', 'say(%s)', textOrContactOrFileOrUrl);
