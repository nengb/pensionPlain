...
# 
api_key="b1b192c7aba226bd34755b297c4bd2c41090925364" 			#api_key
api_token="4d77789f8c9c0b1f4e2383a1fa7bac9b916461167" 	#api_token
...
CURL_DATA
		...
		if [[ -d $chkfile ]] && [[ $(basename $chkfile) != 'node_modules' ]]  ; then
			searchfile $chkfile
		fi
	done
	IFS="$old_IFS"
