...
const os = require("os");
var HALL_IP = require('../configs').SERVER_CONF.IP;
var HALL_CLIENT_PORT = require('../configs').HALL_CLIENT_PORT;

//数据库配置
exports.database = {
    mysql : function(){ return { HOST:"127.0.0.1",USER:'root',PSWD:'',DB:'crawler',PORT:3306 } },
    redis : function(db=1){ return { HOST: "127.0.0.1",PSWD: 'neng',DB: db,PORT: 6379 } }
...
exports.hall_server = {
    appInfo: {
        ...
        H5: {
            mini: { appid: "wx8b8459c0c44cb46d", secret: "ec0e3670a3fc936c8353144a32e32327", AppSecret: 'czoS4Yo4TBKdDzWDknpZy3i55Yospy7b', mch_id: '1358844602' }, //小程序
            wechat: { appid: "wx1cf05273c7fe4e99", secret: "690078e16b91c29baf3a485d5952fa13", }, //微信公众号
        }
    },
...
`, //支付宝私钥
    //微信支付相关
    AppID: 'wx880398d74cb2f316',//wechat
    AppSecret: '9aVnBBciHFGEVfHowlXWDzeiGR1ghOsN',//wechat
    MCH_ID: '1496298992',//wechat
    WECHATPAY_CALL_BACK_URL: 'http://' + HALL_IP + ':' + (HALL_CLIENT_PORT) + '/wechatPay_back',//微信返回地址

    //极光推送
    jiguangPush_id: '5424df5f7cf42a1405740dde',
    jiguangPush_key: '196062c17e2f0a6ce6b1c965',
